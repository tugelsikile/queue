...
-- ----------------------------
-- Table structure for tb_poli_schedule
-- ----------------------------
DROP TABLE IF EXISTS `tb_poli_schedule`;
CREATE TABLE `tb_poli_schedule`  (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  `close` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `quota` int NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `poli_id`(`poli_id`) USING BTREE,
  CONSTRAINT `tb_poli_schedule_ibfk_1` FOREIGN KEY (`poli_id`) REFERENCES `tb_poli` (`poli_id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of tb_poli_schedule
-- ----------------------------
INSERT INTO `tb_poli_schedule` VALUES (1, 1, 7, '07:00', '12:00', 0);
INSERT INTO `tb_poli_schedule` VALUES (2, 1, 7, '07:00', '12:00', 0);
INSERT INTO `tb_poli_schedule` VALUES (3, 9, 7, '07:00', '12:00', 0);
INSERT INTO `tb_poli_schedule` VALUES (5, 9, 2, '07:00', '12:00', 0);
INSERT INTO `tb_poli_schedule` VALUES (7, 10, 1, '07:00', '12:00', 0);
INSERT INTO `tb_poli_schedule` VALUES (8, 10, 2, '07:00', '12:00', 0);
...
-- ----------------------------
-- Table structure for tb_queue_farmasi
-- ----------------------------
DROP TABLE IF EXISTS `tb_queue_farmasi`;
CREATE TABLE `tb_queue_farmasi`  (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `que_id`(`que_id`) USING BTREE,
  CONSTRAINT `tb_queue_farmasi_ibfk_1` FOREIGN KEY (`que_id`) REFERENCES `tb_queue` (`que_id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of tb_queue_farmasi
-- ----------------------------
...
-- Records of tb_user
-- ----------------------------
INSERT INTO `tb_user` VALUES (1, 'admin', '$2y$10$VUon.AX5D4UMxnoE7Gp/ruh6z2jbpzU5ltN3Y6BT8EwmdWcW4UfEW', 99, 1, '2018-04-17 12:26:47', '2022-09-06 18:03:41', 'Admin', NULL);
