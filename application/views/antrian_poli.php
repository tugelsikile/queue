                ...
                if (!$data){
                    ...
                    foreach ($data as $val){
                        ...
                        <div class="col-md-3" style="margin-bottom: 20px">
                            <a class="btn btn-primary btn-block btn-lg" href="javascript:;" data-id="<?php echo $val->poli_id;?>" onclick="show_antrian(this);return false">
                                <?php echo $val->poli_name;?>
                            </a>
                        </div>
                        <?php
                    }
...
<script>
    ...
    function show_antrian(ob) {
        ...
        $('.loading').show();
        $.ajax({
            url     : '<?= site_url()?>/home/show_antrian_poli',
            type    : 'POST',
            dataType: 'JSON',
