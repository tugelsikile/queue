...
<section class="content">
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title repeat-flag"><i class="fa fa-youtube-play"></i> Video</h3>
            ...
            <div class="box-tools pull-right" >
                ...
                <a title="Tambah Video" href="<?php echo base_url('admin/add_video');?>" onclick="show_modal(this);return false" class="btn btn-sm btn-primary mr-5" style="margin-right: 5px">
...
<script>
    function load_data() {
        ...
        $.ajax({
            url     : base_url + 'admin/admin_video_data',
            type    : 'POST',
            dataType: 'JSON',
