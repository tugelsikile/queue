    ...
    <div class="box">
        <div class="box-header with-border">
            ...
            <div class="box-tools pull-right" >
                ...
                <a title="Tambah Video" href="<?php echo site_url('admin/add_video');?>" onclick="show_modal(this);return false" class="btn btn-sm btn-primary mr-5" style="margin-right: 5px">
...
<script>
    function load_data() {
        ...
        $.ajax({
            url     : '<?= site_url()?>/admin/admin_video_data',
            type    : 'POST',
            dataType: 'JSON',
