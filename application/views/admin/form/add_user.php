<form id="new_form" class="form form-horizontal">
    <div class="user_fullname form-group">
        ...
        <div class="col-md-9">
            <input type="text" name="user_fullname" id="user_fullname" class="form-control" placeholder="Nama Lengkap Pengguna" value="">
        </div>
    </div>
    <div class="user_name form-group">
        <label for="user_name" class="control-label col-md-3">Username</label>
        <div class="col-md-9">
            <input type="text" name="user_name" id="user_name" class="form-control" placeholder="Username" value="">
        </div>
    </div>
    <div class="user_password form-group">
        <label for="user_password" class="control-label col-md-3">Password</label>
        <div class="col-md-9">
            <input type="password" name="user_password" id="user_password" class="form-control" placeholder="Password Pengguna">
        </div>
    </div>
...
<script>
    ...
    $('#modal1 #new_form').submit(function (e) {
        ...
        $.ajax({
            url     : '<?= site_url()?>/admin/add_user_submit',
            type    : 'POST',
            dataType: 'JSON',
            data    : $(this).serialize(),
            success : function (dt) {
