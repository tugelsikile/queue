<form id="new_form" class="form form-horizontal">
    <div class="dr_name form-group">
        ...
        <div class="col-md-9">
            <input type="text" name="dr_name" id="dr_name" class="form-control" placeholder="Nama Dokter" value="">
        </div>
    </div>
    ...
    <div class="form-group dr_quota">
        ...
        <div class="col-md-9">
            <input type="number" name="dr_quota" id="dr_quota" class="form-control" placeholder="Max Quota Pendaftaran" min="1" max="1000" step="1" value="100">
        </div>
    </div>
...
<script>
    ...
    $('#modal1 #new_form').submit(function (e) {
        ...
        $.ajax({
            url     : base_url + 'dokter/add_dokter_submit',
            type    : 'POST',
            dataType: 'JSON',
            data    : $(this).serialize(),
            success : function (dt) {
