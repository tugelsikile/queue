<form id="new_form" class="form form-horizontal">
    <input type="hidden" name="djad_id" value="<?php echo $data->djad_id;?>">
    ...
    <div class="form-group djad_jam">
        ...
        <div class="col-md-3 djad_start">
            <input type="text" name="djad_start" id="djad_start" class="form-control" value="<?php echo date('H:i',strtotime($data->djad_time_start));?>">
        </div>
        <div class="col-md-3 djad_end">
            <input type="text" name="djad_end" id="djad_end" class="form-control" value="<?php echo date('H:i',strtotime($data->djad_time_end));?>">
        </div>
    </div>
...
<script>
    $('#djad_day').val('<?php echo $data->djad_day;?>');
    ...
    $('#modal1 #new_form').submit(function (e) {
        ...
        $.ajax({
            url     : '<?= site_url()?>/dokter/edit_jadwal_submit',
            type    : 'POST',
            dataType: 'JSON',
            data    : $(this).serialize(),
            success : function (dt) {
