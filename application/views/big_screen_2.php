...
<head>
    ...
    <!-- <script>
        ...
        channel.bind('panggilan-loket', function(data) {
            console.log(data);
            read_entry();
...
<body>
    ...
    <div id="big_screen_pendaftaran"></div>
    <script src="<?php echo base_url('assets/js/big_screen_pendaftaran.js'); ?>"></script>
    <!-- <div class="content">
            ...
            function text_to_speech(kode, cek = 0) {
                ...
                if (code < 12) {
                    ...
                    setTimeout(function() {
                        ...
                        voice2.onloadedmetadata = function() {
                            setTimeout(function() {
                                ending1();
