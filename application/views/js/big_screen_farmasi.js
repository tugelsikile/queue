...
export default class BigScreenFarmasi extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            playing: true,
    ...
    readEntry() {
        ...
        Promise.resolve(axios({ method: 'post', url: window.origin + '/index.php/big_screen/read_entry_farmasi' }))
            .then((response) => {
    ...
    ending2() {
        ...
        let poli = new Audio(window.origin + '/assets/voices/poli/poli farmasi.mp3');
        poli.play();
        setTimeout(() => {
...
if (document.getElementById('big_screen_farmasi')) {
    ReactDOM.render(<BigScreenFarmasi />, document.getElementById('big_screen_farmasi'));
}