...
export default class BigScreenPendaftaran extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            playing: true,
    ...
    readEntry() {
        ...
        Promise.resolve(axios({ method: 'post', url: window.origin + '/index.php/big_screen/read_entry' }))
            .then((response) => {
                                ...
                                <div id="jp_container_N" style={{ borderWidth: '10px' }}>
                                    <ReactPlayer
                                        ...
                                        onPlay={() => {
                                            ...
                                            let video_width = document.querySelector('.videoWrapper').clientWidth;
...
if (document.getElementById('big_screen_pendaftaran')) {
    ReactDOM.render(<BigScreenPendaftaran />, document.getElementById('big_screen_pendaftaran'));
}